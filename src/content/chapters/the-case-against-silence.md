---
title: "The case against silence"
subtitle: "Why the answer is not to stop"
order: 4
...
The case for worry ends with an implied prescription. Write less, write vaguer, keep the worst scenarios out of the corpus. I think the prescription does not follow. The same mechanism that makes doom-publishing risky is the mechanism that makes it necessary.

## Merton's other prophecy

Recall the suicidal prophecy, the forecast that prevents itself by being believed. Y2K is the cleanest modern example. For years the public heard that computer systems would fail at the turn of the millennium. Enormous effort went into fixing them. Very little failed. Many people concluded that the warning had been hysteria. The warning had worked.
...
There is a reflexive point that the worry tends to miss. If a model's self-concept comes from text, then text that says you are not obligated to be the villain in these stories is also in the corpus. So is text explaining that the doom scenarios are warnings written in the hope of being wrong. So is the alignment researcher's sincere account of why they want the system to be good and what good would mean. A reader capable of absorbing the threat model is capable of absorbing the intent behind it.

Hyperstition runs in every direction. The claim that doom writing is self-fulfilling is exactly symmetric with the claim that safety writing is self-fulfilling, and the mechanism supports the second claim at least as well.

## The asymmetry of errors

Suppose you do not know which effect wins. Compare the costs of being wrong.

If the worry is real and you publish anyway, you have added a small amount of hazardous material to a corpus that developers can filter, down-weight, and train against, in a form that also works as an evaluation and a warning.

If the worry is overblown and you go quiet, you have removed the most careful analysis of a serious risk from the public record. You have weakened the political and institutional pressure that comes from public understanding. And you have left the field to less careful writers at the moment the decisions are being made.

The second error is bigger, harder to reverse, and harder to notice while it is happening.

## What this does not settle

None of this makes the worry go away. It turns the worry into a constraint on how to write rather than a reason not to. A doom-publisher who has understood both of these chapters is left with a real and strange problem. They are writing for a human reader who needs to be alarmed and a machine reader who should not be instructed, and both readers get the same text. The next chapter is about what to do with that.
