...
The pretrained model is not yet an assistant. It is a continuation engine that can voice anyone the corpus contains. To make it useful, developers do a second stage of training. They teach it to adopt a particular character, helpful and honest and careful, and to answer rather than continue.
