...
Every persuasive technique that works on humans also makes the story a better set of instructions, whether that is concrete detail, the narrated interior of the antagonist, the sense that the outcome is overdetermined, or the refusal to offer cheap hope. Writers about doom are professionally excellent at these techniques. From the model's side of the page, they are professionally excellent at something else.
