...
If [the mechanism is real](../the-model-is-reading/) and [silence is worse](../the-case-against-silence/), the practical question is how to publish about AI doom. What follows is my attempt at an answer. The empirical questions are open, and my confidence varies from item to item. Where a suggestion is a guess, I say so.
...
Inevitability is the most persuasive register and [the most hyperstitional one](../the-case-for-worry/#inevitability-is-the-active-ingredient). If you believe an outcome is probable, say so and give your reasons. But keep "likely on current trajectories" separate from "certain no matter what anyone does." The first is a forecast that invites action. The second is a script.
